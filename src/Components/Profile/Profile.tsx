      ...
      >
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="light:text-gray-500 dark:text-gray-100">
              {user.email}
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="border-t dark:border-white pt-4">
            <label className="light:text-gray-700 dark:text-gray-100 font-medium block mb-1">
              Role:
            </label>
            <p className="light:text-gray-600 dark:text-gray-100">
              {user.role || "N/A"}
            </p>
          </div>
          <div>
