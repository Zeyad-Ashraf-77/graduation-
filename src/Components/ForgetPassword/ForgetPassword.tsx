...
export default function ForgetPassword() {
  ...
  return (
    <>
    <ToastContainer/>
      <form onSubmit={formik.handleSubmit} className="max-w-sm mt-28 mx-auto">
        ...
        <a href="/login" className="text-amber-500 hover:underline">Back to login</a>
        <a href="/resetPassword" className="text-amber-500 hover:underline">Go to reset password</a>
        </div>
        </div>
