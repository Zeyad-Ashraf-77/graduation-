...
export default function ProductListPage() {
  ...
  return (
    <div className="bg-[#f9f9f6] text-gray-800 mt-16 font-sans min-h-screen">
      {/* Products Grid */}
          ...
          {isLoading
            ? // عرض كروت Placeholder أثناء اللودينج
              Array.from({ length: 8 }).map((_, index) => (
                <div
                  key={index}
                  className="bg-gray-300 animate-pulse rounded shadow p-4"
                >
            ...
            : // عرض الكروت الفعلية بعد تحميل البيانات
              products.map((product) => (
                <div
                  key={product._id}
                  className="bg-white rounded shadow hover:shadow-2xl duration-500 hover:shadow-yellow-500 p-4 transition"
                >
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <p className="text-brown-600 font-bold mb-2 flex items-center gap-1">
