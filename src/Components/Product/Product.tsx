                  ...
                  >
                    ...
                    <div className="flex justify-between gap-1 items-center">
                      <button
                        ...
                        type="button"
                        className="py-2.5 w-full px-5 mb-2  flex justify-center  text-sm font-bold   items-center gap-1 text-white hover:scale-110 transition-all duration-500 rounded-2xl bg-yellow-700 cursor-pointer "
                      >
                        <span>
                          {isLoading1 ? (
