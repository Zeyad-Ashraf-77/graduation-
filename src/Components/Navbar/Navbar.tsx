              ...
              <div className="hidden md:flex flex-row items-center justify-end gap-4 w-full">
                ...
                {localStorage.getItem("authorization") && (
                  <div className="relative">
                    ...
                    <ul
                      className={`absolute right-0 mt-2 w-48 bg-black dark:bg-white border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-50 transition-opacity duration-300 ease-in-out ${
                  ...
                  {localStorage.getItem("authorization") && (
                    <div className="relative w-full">
                      ...
                      <ul
                        ...
                        className={`w-full mt-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-50 transition-opacity duration-300 ease-in-out ${
                          isProfileDropdownOpen ? "block" : "hidden"
